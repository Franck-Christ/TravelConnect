...
export const TravelIcon: React.FC<IconProps> = ({ size = 24, className = '', ...props }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const BookmarkIcon: React.FC<IconProps> = ({ size = 24, className = '', ...props }) => {
  return (
    <svg
      width={size}
      height={size}
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`feather feather-bookmark ${className}`}
      {...props}
    >
...
//export const DashboardIcon = () => <svg>...</svg>; // Or however it's defined
